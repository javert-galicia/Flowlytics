                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Productos y Servicios - altura fija
                          SizedBox(
                            height: 200,
                            child: ValuePropositionSection(
                              id: 'products',
                              title: 'Productos y Servicios',
                              subtitle: 'Lista de productos y servicios que ofreces',
                              ...
                              children: [
                                Expanded(
                                  child: ValuePropositionSection(
                                    id: 'painRelievers',
                                    title: 'Aliviadores',
                                    subtitle: 'Cómo alivias las frustraciones',
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Trabajos del Cliente - altura fija
                          SizedBox(
                            height: 200,
                            child: ValuePropositionSection(
                              id: 'customerJobs',
                              title: 'Trabajos del Cliente',
                              subtitle: 'Qué tareas intenta realizar',
        ...
        children: [
          ...
          Container(
            ...
            child: ValuePropositionSection(
              ...
              subtitle: 'Cómo alivias las frustraciones del cliente',
              content: canvas.getContentById('painRelievers'),
              onChange: (content) => _updateSection('painRelievers', content),
              area: ValuePropositionArea.valueMap,
            ),
          ...
          Container(
            ...
            child: ValuePropositionSection(
              ...
              subtitle: 'Cómo creas alegrías para el cliente',
              content: canvas.getContentById('gainCreators'),
              onChange: (content) => _updateSection('gainCreators', content),
              area: ValuePropositionArea.valueMap,
            ),
          ...
          Container(
            ...
            child: ValuePropositionSection(
              id: 'customerJobs',
              title: 'Trabajos del Cliente',
              subtitle: 'Qué tareas intenta realizar el cliente',
              content: canvas.getContentById('customerJobs'),
              onChange: (content) => _updateSection('customerJobs', content),
              area: ValuePropositionArea.customerProfile,
            ),
          ...
          Container(
            ...
            child: ValuePropositionSection(
              id: 'pains',
              title: 'Frustraciones del Cliente',
              subtitle: 'Qué frustra o molesta al cliente',
              content: canvas.getContentById('pains'),
              onChange: (content) => _updateSection('pains', content),
              area: ValuePropositionArea.customerProfile,
            ),
          ...
          Container(
            ...
            child: ValuePropositionSection(
              id: 'gains',
              title: 'Alegrías del Cliente',
              subtitle: 'Qué emociona o beneficia al cliente',
              content: canvas.getContentById('gains'),
              onChange: (content) => _updateSection('gains', content),
              area: ValuePropositionArea.customerProfile,
            ),
